...
public struct VoiceProbeSnapshot: Codable, Equatable, Sendable {
  ...
  public static func idle(sequence: UInt64) -> VoiceProbeSnapshot {
    VoiceProbeSnapshot(
      phase: .idle,
      sessionID: nil,
      sequence: sequence,
...
public enum VoiceProbeKeyboardDecision: Equatable, Sendable {
...
public struct VoiceProbeInsertionReceipt: Codable, Equatable, Sendable {
  public let sessionID: UUID
  public let sequence: UInt64
...
public struct VoiceProbeKeyboardPolicy: Equatable, Sendable {
  ...
  public func microphoneDecision(
    ...
    now: Date
  ) -> VoiceProbeKeyboardDecision {
    guard hasFullAccess else {
      return .requiresFullAccess
    }
    guard snapshot.schemaRevision == VoiceProbeSnapshot.schemaRevision else {
      return .serviceStale
    }
